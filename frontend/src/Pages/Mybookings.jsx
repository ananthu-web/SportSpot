...
function MyBookings() {
  ...
  if (!user) return <p className="text-center text-white mt-10">Please log in to see your bookings.</p>;
  if (loading) return <p className="text-center text-white mt-10">Loading bookings...</p>;
  if (error) return <p className="text-center text-red-500 mt-10">{error}</p>;
  if (bookings.length === 0) return <p className="text-center text-white mt-10">No bookings found.</p>;
